...
10.times do |n|
  10.times do |m|
    ...
    c = Customer.create!(
      ...
      password: "password",
      birthday: 30.years.ago.advance(seconds: rand(30.years)).to_date,
      gender: m < 5 ? "male" : "female"
    )
    if m % 2 == 0
      c.personal_phones.create!(
        number: sprintf("090-0000-%04d", n * 10 + m))
    end
    ...
    if m % 10 == 0
      c.home_address.phones.create!(
        number: sprintf("03-0000-%04d", n))
    end
    if m % 3 == 0
